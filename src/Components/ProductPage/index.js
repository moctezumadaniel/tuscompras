  ...
  return (
    <div className={styles.MainDetails}>
      ...
      <div className={styles.Buttons}>
        <button className={styles.Buy}>{titles.buy}</button>
        <button className={styles.Contact}>{titles.contact}</button>
      </div>

      <div className={styles.ShortDescription}>{titles.shortDescription}</div>

      <div className={styles.Amounth}>{titles.amounth}</div>
    </div>
  );
}
    ...
    <div className={styles.CommentsContainer}>
      <div className={styles.CommentsSummary}>
        <div className={styles.CommentsHeader}>
          <span className={styles.Review}>{titles.review}</span>
...
function FullDescription() {
  return (
    <div className={styles.CompleteDescriptionContainer}>
      <div className={styles.CompleteDescription}>{titles.fullDescription}</div>
    </div>
  );
}
